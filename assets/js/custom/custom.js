...
/* --- GECE MODU (DARK MODE) GLOBAL HAFIZA OKUYUCU --- */
/* Kullanıcı test sayfalarında gezinirken hafızadaki temayı anında uygular */
if (localStorage.getItem('statlab_theme') === 'dark') {
